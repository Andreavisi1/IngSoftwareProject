...
class TestControlloreListaTesserati(TestCase):
    ...
    def test_aggiungi_tesserato(self):
        ...
        self.tesserato = Tesserato("mariorossi", "Mario", "Rossi", "RSSMRA66A02A271R", "mariorossi@outlook.it", "3458256745", "Ancona", "18", "rossirossi00", "Juniores", "15", "5", "01/01/2023", "01/01/2024")
